...
if (process.argv.length < 7) {
    console.log('node http.js <url> <time> <requests> <threads> <proxy> ( options: <cookie> )');
    process.exit();
}
...
'Mozilla/5.0 (Linux; Android 11; RMX2170) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/16.0 Chrome/92.0.4515.166 Mobile Safari/537.36',
    ...
    if (cluster.isMaster) {
        ...
        console.log(`HTTPv2 update header Khacute`.gray);
    ...
    headers["accept"] = "text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;vb3;q=0.7";
  ...
  headers["cookie"]= "cf_clearance=160XPawPfAlLVGcuIANRNrD900fD_NubRMIYCPP_OKA-1692845160-0-1-658c414f.fd081f4b. 11179870-0.2.1692845160";
    headers["sec-ch-ua"] = '"Chromium";v="1116",  "Google Chrome";y="116", "Not)A;Brand";v="24"';
